            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    command.CommandText = // заповнення таблиці [Замовлення]
                       ...
                       "           (N'Комфорт Таун',    N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   250,    1015,   0.0,            '12.12.2022')," +
                       "           (N'Аудит Прем`єр',   N'Лінер 0.4мм GRAPH PEPS MP.74911 MAPED чорний',                            N'Ручка',                   95,     1001,   0.0,            DEFAULT)," +
                       "           (N'Предикат',        N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',                 200,    1005,   0.0,            '11.21.2022')," +
                       "           (N'БухБюро',         N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   3500,   1001,   0.0,            '01.01.2020')," +
                       "           (N'Аудит 911',       N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',   110,    1010,   0.0,            '09.29.2021')," +
                       "           (N'Фенікс Аккаунт',  N'Лінер 0.4мм GRAPH PEPS MP.74911 MAPED чорний',                            N'Ручка',                   46,     1009,   0.0,            '03.27.2020')," +
                       "           (N'Бест Клінік',     N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   250,    1014,   0.0,            '09.09.2022')," +
                       "           (N'Парацельс',       N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',                 340,    1011,   0.0,            '05.23.2021')," +
                       "           (N'Пан Диван',       N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   2100,   1001,   0.0,            DEFAULT)," +
                       "           (N'Есентуки',        N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   345,    1017,   0.0,            DEFAULT)," +
                       "           (N'Факстрот',        N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   3650,   1017,   0.0,            '10.10.2020')," +
                       "           (N'Альянс Холдинг',  N'Кошик для сміття пластиковий чорний 82061 Арніка',                        N'Кошики для паперу',       210,    1003,   0.0,            DEFAULT)," +
                       "           (N'Ерідон',          N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   210,    1007,   0.0,            DEFAULT)," +
                       "           (N'Фармак',          N'Кошик для сміття пластиковий чорний 82061 Арніка',                        N'Кошики для паперу',       110,    1013,   0.0,            '07.02.2021')," +
                       "           (N'Росава',          N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',   150,    1016,   0.0,            DEFAULT)," +
                       "           (N'Оболонь',         N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',                 600,    1001,   0.0,            '04.14.2020')," +
                       "           (N'Рітейл Груп',     N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   3300,   1015,   0.0,            '10.05.2022');";
                    /*
                    command.CommandText =
