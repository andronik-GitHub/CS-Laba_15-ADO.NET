            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    command.CommandText = // заповнення таблиці [Замовлення]
                       ...
                       "   VALUES  (N'ДоброБуд',        N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',0,1000,0.0,2022/05/18)," +
                       "           (N'ВашБудинок',      N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Комфорт Таун',    N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',0,1000,0.0,2022/05/18)," +
                       "           (N'Аудит Прем'єр',   N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Предикат',        N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',0,1000,0.0,2022/05/18)," +
                       "           (N'БухБюро',         N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Аудит 911',       N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',0,1000,0.0,2022/05/18)," +
                       "           (N'Фенікс Аккаунт',  N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Бест Клінік',     N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',0,1000,0.0,2022/05/18)," +
                       "           (N'Парацельс',       N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',0,1000,0.0,2022/05/18)," +
                       "           (N'Пан Диван',       N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Есентуки',        N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',0,1000,0.0,2022/05/18)," +
                       "           (N'Факстрот',        N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Альянс Холдинг',  N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Ерідон',          N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',0,1000,0.0,2022/05/18)," +
                       "           (N'Фармак',          N'',N'',0,1000,0.0,2022/05/18)," +
                       "           (N'Росава',          N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',0,1000,0.0,2022/05/18)," +
                       "           (N'Оболонь',         N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',0,1000,0.0,2022/05/18)," +
