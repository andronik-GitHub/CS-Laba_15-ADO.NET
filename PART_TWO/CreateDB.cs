            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    command.CommandText = // заповнення таблиці [Замовлення]
                       ...
                       "   VALUES  (N'ДоброБуд',        N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',   240,    1018,   0.0,'2022/05/12')," +
                       "           (N'ВашБудинок',      N'Лінер 0.4мм GRAPH PEPS MP.74911 MAPED чорний',                            N'Ручка',                   80,     1010,   0.0,'2021/06/28')," +
                       "           (N'Комфорт Таун',    N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   250,    1015,   0.0,'2022/01/12')," +
                       "           (N'Аудит Прем`єр',   N'Лінер 0.4мм GRAPH PEPS MP.74911 MAPED чорний',                            N'Ручка',                   95,     1001,   0.0,'2020/10/21')," +
                       "           (N'Предикат',        N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',                 200,    1005,   0.0,'2022/01/04')," +
                       "           (N'БухБюро',         N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   3500,   1001,   0.0,'2022/08/17')," +
                       "           (N'Аудит 911',       N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',   110,    1010,   0.0,'2021/02/23')," +
                       "           (N'Фенікс Аккаунт',  N'Лінер 0.4мм GRAPH PEPS MP.74911 MAPED чорний',                            N'Ручка',                   46,     1009,   0.0,'2020/09/25')," +
                       "           (N'Бест Клінік',     N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   250,    1014,   0.0,'2022/00/18')," +
                       "           (N'Парацельс',       N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',                 340,    1011,   0.0,'2021/06/02')," +
                       "           (N'Пан Диван',       N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   2100,   1001,   0.0,'2020/08/17')," +
                       "           (N'Есентуки',        N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   345,    1017,   0.0,'2022/11/13')," +
                       "           (N'Факстрот',        N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   3650,   1017,   0.0,'2022/12/08')," +
                       "           (N'Альянс Холдинг',  N'Кошик для сміття пластиковий чорний 82061 Арніка',                        N'Кошики для паперу',       210,    1003,   0.0,'2021/08/16')," +
                       "           (N'Ерідон',          N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',           N'Ручка',                   210,    1007,   0.0,'2020/04/14')," +
                       "           (N'Фармак',          N'Кошик для сміття пластиковий чорний 82061 Арніка',                        N'Кошики для паперу',       110,    1013,   0.0,'2022/07/01')," +
                       "           (N'Росава',          N'Ножиці 16см чорні BM.4507-01 Buromax',                                    N'Канцелярське приладдя',   150,    1016,   0.0,'2021/08/14')," +
                       "           (N'Оболонь',         N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',  N'Точилки',                 600,    1001,   0.0,'2022/01/18')," +
                       "           (N'Рітейл Груп',     N'СКОБИ 24/6 BM. 4402 нікель',                                              N'Канцелярське приладдя',   3300,   1015,   0.0,'2020/05/26');";
                    /*
                    command.CommandText =
