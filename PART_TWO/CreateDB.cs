            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    command.CommandText = // заповнення таблиці [Канцтовари]
                       ...
                       "   VALUES  (N'Фломастери OL-917-6к Фломіки 6цв',N'Фломастери',0,1000,13.0)," +
                       "           (N'Фломастери OL-916-6 Фломиіи 6цв',N'Фломастери',0,1000,14.0)," +
                       "           (N'Фломастери Ol-917-6T Turbo 6цв',N'Фломастери',0,1000,14.0)," +
                       "           (N'Блокнот на пружині зверху SHOTLANDKA, А6, 48 арк., клітинка, синій',N'Блокноти',0,1000,16.99)," +
                       "           (N'Зошит А5 32 аркушів клітинка Interdruk HS Kraft 93800',N'Блокноти',0,1000,34.99)," +
                       "           (N'Ручка Паркер Sonnet 17 Matte Black Lacquer позол. кул. 84 832',N'Ручка',0,1000,6499.0)," +
                       "           (N'Лінер 0.4мм GRAPH PEPS MP.74911 MAPED чорний',N'Ручка',0,1000,54.99)," +
                       "           (N'Ручка кулькова Buromax 8117 синій 01',N'Ручка',0,1000,4.99)," +
                       "           (N'ГУМКА ВМ.1111 для стирання',N'Гумки',0,1000,8.99)," +
                       "           (N'ГУМКА ВМ.1112 для стирання',N'Гумки',0,1000,9.99)," +
                       "           (N'Точилка ТВАРИНКИ ZB.5594 з контейнером, 2 отв., асорті для олівців',N'Точилки',0,1000,29.99)," +
                       "           (N'Точилка з контейнером Buromax Alfa 2 отвори асорті BM.4778 для олівців',N'Точилки',0,1000,29.99)," +
                       "           (N'Кошик для сміття пластиковий чорний 82061 Арніка',N'Кошики для паперу',0,1000,84.99)," +
                       "           (N'Кошик для сміття металевий сітка 3126 ZiBi синій',N'Кошики',0,1000,399.90)," +
                       "           (N'Швидкозшивач картонний Аспект білий',N'Офісна паперова продукція',0,1000,5.99)," +
                       "           (N'Обкладинка картонна Справа Аспект',N'Офісна паперова продукція',0,1000,4.99)," +
                       "           (N'Конверт DL СКЛ білий 2052,2040',N'Офісна паперова продукція',0,1000,1.99)," +
                       "           (N'СКОБИ 24/6 BM. 4402 нікель',N'Канцелярське приладдя',0,1000,13.99)," +
                       "           (N'Ножиці 16см чорні BM.4507-01 Buromax',N'Канцелярське приладдя',0,1000,29.99);";
                    /*
                    command.CommandText =
