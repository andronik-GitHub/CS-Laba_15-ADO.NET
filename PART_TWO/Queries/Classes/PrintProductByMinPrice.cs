...
internal class PrintProductByMinPrice : IQuery
{
    public SqlConnection connection { get; }

    public PrintProductByMinPrice(SqlConnection connection) => this.connection = connection;
    ...
    public async Task Query() // приймається підключення і назва таблиці
    {
        var command = new SqlCommand
        {
            ...
            CommandText = "SELECT [Тип канцтовару],MIN([Собівартість]) AS [Мін. cобівартість] FROM [Канцтовари] GROUP BY [Тип канцтовару]" // текст команди
        };
