...
internal class PrintProductByMaxPrice : IQuery
{
    public SqlConnection connection { get; }

    public PrintProductByMaxPrice(SqlConnection connection) => this.connection = connection;
    ...
    public async Task Query() // приймається підключення і назва таблиці
    {
        var command = new SqlCommand
        {
            ...
            CommandText = "SELECT [Тип канцтовару],MAX([Собівартість]) AS [Макс. cобівартість] FROM [Канцтовари] GROUP BY [Тип канцтовару]" // текст команди
        };
